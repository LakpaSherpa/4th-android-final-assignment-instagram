...
import com.pasangsherpa.instagram.LoginApi;
import com.pasangsherpa.instagram.R;
import com.pasangsherpa.instagram.Url;
import com.pasangsherpa.instagram.models.UserModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserModel userRegister = new UserModel(email, etUsername.getText().toString(), etPassword.getText().toString());
